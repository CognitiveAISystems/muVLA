...
def mikasa_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # MIKASA-Robo actions are already in the correct format: Delta EEF XYZ(3) + Delta RPY(3) + Delta Gripper(1)
    # Proprio is already in the correct format: EEF XYZ(3) + RPY(3) + Gripper(1)
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "shell_game_push_vla_v0": mikasa_dataset_transform,
    "intercept_medium_vla_v0": mikasa_dataset_transform,
    "remember_color5_vla_v0": mikasa_dataset_transform,
    "take_it_back_vla_v0": mikasa_dataset_transform,
    "remember_shape_and_color3x3_vla_v0": mikasa_dataset_transform,
