...
OXE_DATASET_CONFIGS = {
    ...
    # NOTE: Keys must be snake_case (TFDS requirement). On disk, create snake_case symlinks
    # pointing to the original directories (e.g., shell_game_push_vla_v0 -> ShellGamePush-VLA-v0).
