...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # NOTE: Dataset names must be snake_case (TFDS requirement).
    # On disk, create symlinks: e.g., shell_game_push_vla_v0 -> ShellGamePush-VLA-v0
    "mikasa_five": [
        ("shell_game_push_vla_v0", 1.0),
        ("intercept_medium_vla_v0", 1.0),
        ("remember_color5_vla_v0", 1.0),
        ("take_it_back_vla_v0", 1.0),
        ("remember_shape_and_color3x3_vla_v0", 1.0),
    ],
    "shell_game_push_vla_v0": [
        ("shell_game_push_vla_v0", 1.0),
    ],
    "intercept_medium_vla_v0": [
        ("intercept_medium_vla_v0", 1.0),
    ],
    "remember_color5_vla_v0": [
        ("remember_color5_vla_v0", 1.0),
    ],
    "take_it_back_vla_v0": [
        ("take_it_back_vla_v0", 1.0),
    ],
    "remember_shape_and_color3x3_vla_v0": [
        ("remember_shape_and_color3x3_vla_v0", 1.0),
    ],
